...
if( ! function_exists('form_open') )
{
	function form_open($action = '', $attributes = array(), $hidden = array())
	{
		...
		/*****KNOWN BUG***************************************************************************************************************
			Removed check for token library. Library is loaded and alias set in "APPPATH. 'third-party/MX/Loader'" on Line 177
			Currently App will throw error if token lib is not loaded 
		*****************************************************************************************************************************/
...
/* Location: /auth/helpers/MY_form_helper.php */